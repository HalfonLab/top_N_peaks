...
# Halfon Lab
# Data Sept 2018 
# This script creates a BED-compatible file with the N top good peaks (based on Amplitude and SCRMshaw score) for each training set and method from a SCRMshaw-HD output.
